        ...
        <Link to={`/job/${index}`} key={job.link}>
          ...
          >
            <Card.Body>
              ...
              <Card.Subtitle className="mb-2" style={{color: colorMode ? 'white' : 'black'}}>{job.company}</Card.Subtitle>
              <Card.Subtitle className="mb-2" style={{color: colorMode ? 'white' : 'black'}}>{job.location}</Card.Subtitle>

              ...
              {isAuthenticated ?
                  (<>
                      ...
                      <Routes>
                        <Route
                            path="/*"
                            element={<Input colorMode={colorMode} setColorMode={setColorMode} handleToggle={handleToggle} jobData={jobData} setJobData = {setJobData}/>}
                        />
                        <Route
                            path="/job/:jobId"
                            element={<JobDetail colorMode={colorMode} setColorMode={setColorMode} handleToggle={handleToggle} jobData={jobData} />}
                        />
                      </Routes>
                  </>) :
